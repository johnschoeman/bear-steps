+++
title = "Sample Policy - Air Steps Not Permitted - Bear Steps"
description = "Use this policy when air steps are not appropriate for your event due to venue constraints, insurance limitations, participant skill levels, or safety concerns."

[extra]
page_title = "AIR STEPS NOT PERMITTED"
+++
...
1. **First instance:** Immediate but friendly intervention and policy reminder
2. **Any subsequent attempts:** Temporary removal from dance floor
3. **Continued violations:** Removal from event without refund
